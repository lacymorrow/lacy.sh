...
const tools = [
  {
    ...
    why: "Best for complex coding tasks, architecture questions, and multi-file analysis. Anthropic's latest models with strong reasoning.",
    install: "npm install -g @anthropic-ai/claude-code",
    toolSet: "tool set claude",
  },
  {
    slug: "opencode",
    name: "OpenCode",
    maker: "OpenCode AI",
    command: "opencode run -c \"query\"",
    sessionContinuity: true,
    preheating: true,
    openSource: true,
    localModels: false,
    ...
    why: "Strong open-source alternative with background server support. Lacy's preheating keeps it warm between queries.",
    install: "See github.com/opencode-ai/opencode",
    toolSet: "tool set opencode",
  },
  {
    slug: "gemini",
    name: "Gemini CLI",
    maker: "Google",
    command: "gemini --resume -p \"query\"",
    sessionContinuity: true,
    preheating: false,
    openSource: false,
    localModels: false,
    ...
    why: "Long-context understanding and strong coding support. Good fit for Python and data-heavy projects.",
    install: "See github.com/google-gemini/gemini-cli",
    toolSet: "tool set gemini",
  },
];
